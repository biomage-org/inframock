...
migrate:
	@NODE_ENV=development AWS_ACCOUNT_ID=000000000000 AWS_REGION=eu-west-1 SANDBOX_ID=fake knex migrate:latest --cwd ../iac/migrations/sql-migrations/
migrate-down:
	@NODE_ENV=development AWS_ACCOUNT_ID=000000000000 AWS_REGION=eu-west-1 SANDBOX_ID=fake knex migrate:rollback --all --cwd ../iac/migrations/sql-migrations/
cleanup-sql:
	rm -rf pg_data
